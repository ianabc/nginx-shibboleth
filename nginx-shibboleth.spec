...
Source400:         nginx-http-shibboleth-v2.0.1.tar.gz
...
mkdir ./src/http/modules/shibboleth
tar --strip-components=1 -C ./src/http/modules/shibboleth -zxvf %{SOURCE400}
...
%endif
    ...
    --add-dynamic-module=./src/http/modules/shibboleth \
%if 0%{?with_gperftools}
